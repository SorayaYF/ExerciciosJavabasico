package br.com.trier.aula_6.exercicio_medicamento.utils;
...
import br.com.trier.aula_6.exercicio_medicamento.models.Medicamento;
import br.com.trier.aula_6.exercicio_medicamento.models.Pessoa;
...
class ConsultorioTest {
	...
	void init() {
		...
		Medicamento m1 = new Medicamento("Medicamento 1", Administracao.ORAL);
		m1.addIndicacao("Dor");
		m1.addIndicacao("Febre");
		m1.addContraIndicacao("Diabetes");
		
		Medicamento m2 = new Medicamento("Medicamento 2", Administracao.ORAL);
	...
	void addMedicamento() {
		Medicamento m = new Medicamento("Teste 1", Administracao.ORAL);
